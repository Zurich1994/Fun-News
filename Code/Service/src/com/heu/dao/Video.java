...
public class Video {
	...
	private int user_id;
	private int serise;
	public Video(int fun_id, String fun_content, String fun_time,
			String user_name,
			String user_head, int comment_count, int praise_count,
			int down_count,int share_count,String sign1, String sign2, String sign3,int serise,String video_name,String photo_name) {
		super();
		this.fun_id = fun_id;
