...
import com.heu.dao.Video;

public class VideoServiceImpl {
	public static List<Video> getList(int user_id,int operate,String time)
	{
		...
		{
			String sql="select t_user_info.User_name,t_user_info.User_image,fun_fun.fun_content,fun_fun.video_name,fun_fun.fun_time,fun_fun.fun_id,fun_fun.Praise_count,fun_fun.Down_count,fun_fun.Comment_count,fun_fun.fun_sign1,fun_fun.fun_sign2,fun_fun.fun_sign3,fun_fun.share_count,fun_fun.series,fun_fun.photo_name from t_user_info,fun_fun where t_user_info.User_id=fun_fun.user_id and series in(3,4) and fun_fun.fun_time<'"+time+"' ORDER BY fun_fun.fun_time DESC LIMIT 0,10";
			pstmt=conn.prepareStatement(sql);
			rs=pstmt.executeQuery();
		}
		...
		{   a=rs.getString(1);
			...
			list.add(new Video(f,c,ee,a,b,j,g,h,w,k,o,p,x,d,q));
		}
