...
public class ShouYeFragment extends Fragment {
    ...
    private WordFragment  frag2;
    private PicFragment   frag3;
    private SoundFragment frag4;
    private VideoFragment frag5;
...

    {
        ...
        frag2=new WordFragment();
        frag3=new PicFragment();
        frag4=new SoundFragment();
        frag5=new VideoFragment();
