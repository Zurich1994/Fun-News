...
public class MainActivity extends FragmentActivity
        implements View.OnClickListener,ArcMenu.OnMenuItemClickListener{
    ...
    private ImageButton mJump;
    private ImageButton mEditInfo;

    /**
     * 文 图 声 视
     */
    private ImageView wen,tu,sheng,shi;
    ...
    private void initView()
    {
        ...
        mJump=(ImageButton)findViewById(R.id.jump);
        mEditInfo=(ImageButton)findViewById(R.id.editinfo);
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId())
        {
            ...
            case R.id.jump:
            {
                popmenu=new PopupMenu(getApplicationContext(),view);
                popmenu.getMenuInflater()
                        .inflate(R.menu.popup_menu, popmenu.getMenu());
    ...
    public interface setNicknameInterface{
        public void setnickname(String s);
    }

    public void setOnNicknameInterface(setNicknameInterface sni)
    {
        this.sni=sni;
    }
    /**
    ...
    public void onClick(View view, int pos) {
        ...
        switch (view.getId())
      {
        case R.id.wen:
        {
            Toast tos=Toast.makeText(this,"ddddd",Toast.LENGTH_SHORT);
            tos.show();
            SharedPreferences spf=getSharedPreferences("userConfig",MODE_PRIVATE);
            SharedPreferences.Editor edt=spf.edit();
            edt.putString("user_name", "alex");
            edt.commit();
            Log.d("-----用户name", spf.getString("user_name", "x"));
            break;
        }
      }
    ...
    public void hideTitleRightIcon()
    {
        mRefresh.setVisibility(View.GONE);
        mJump.setVisibility(View.GONE);
        mEditInfo.setVisibility(View.GONE);
    }
}
