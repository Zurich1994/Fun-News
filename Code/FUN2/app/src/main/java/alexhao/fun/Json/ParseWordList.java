...
public class ParseWordList {
     ...
     * @param list
     */
    public ParseWordList(List list) {
        this.mlist=list;
     ...
     */
    public List<MainListBean> parseWordlist(int mtype,JSONArray jarr) throws JSONException {
    ...
    public void getParse(JSONArray jarr)throws JSONException
    {
        for(int i=0;i<jarr.length();i++) {
            ...
            Log.d("AAAAAAAAAAAAAAAAA1", id + touxiang + name + time + word + img + tag1 + tag2 + tag3 + zan + cai + pinglun + share + type+video);
        }
