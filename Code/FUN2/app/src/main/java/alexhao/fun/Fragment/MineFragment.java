...
public class MineFragment extends Fragment implements View.OnClickListener,MainActivity.setNicknameInterface{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==1)
        {
            ...
            {
                String nick;
                nick = data.getStringExtra("username");
                Log.d("nick", nick);
    ...
    public void setnickname(String s) {
        this.nickname.setText(s);
        Toast tos=Toast.makeText(getActivity(),s,Toast.LENGTH_SHORT);
        tos.show();
    }
}
